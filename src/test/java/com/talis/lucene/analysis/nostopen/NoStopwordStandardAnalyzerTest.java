...
public class NoStopwordStandardAnalyzerTest {

	  public static junit.framework.Test suite()
	  {
	    return new JUnit4TestAdapter(NoStopwordStandardAnalyzerTest.class);
	  }

	  @Test
	  public void testNoStopwordStandard() throws Exception {
	    Analyzer a = new NoStopwordStandardAnalyzer();
